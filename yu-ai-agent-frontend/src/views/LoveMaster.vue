...
import { chatWithGuideApp } from '../api'
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI智能行程助手是专业出行顾问，帮你解答各种旅游问题'
    },
    {
      name: 'keywords',
      content: 'AI智能行程助手,AI聊天AI智能体'
    }
  ]
})
...
const sendMessage = (message) => {
  ...
  eventSource = chatWithGuideApp(message, chatId.value)
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('欢迎来到AI智能行程助手，请告诉我你想去哪个城市？我会为您制作详细的旅游方案。', false)
})
