  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">AI智能行程</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-info">
          <div class="app-title">AI智能行程助手</div>
          <div class="app-desc">智能旅游顾问，提供智能建议和解决方案</div>
        </div>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI智能行程提供AI智能行程助手和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI智能行程助手,AI助手,智能对话,鱼皮,AI超级智能体,首页'
    }
  ]
})
